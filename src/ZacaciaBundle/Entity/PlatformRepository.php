...
use Zacacia\LdapUtils\Core\LdapObject;

class PlatformRepository extends LdapPeer
{
    ...
    public function findAllOrderedByName()
    {
        ...
        $entries = $this->doSearch($criteria, 'Platform');

        return $entries;
    }

    public function doSubTree(Platform $ldap_object)
    {
        $subtree = true;
    ...
    {
        $criteria = new LDAPCriteria();
        $criteria->setBaseDn($platform->getDn());
