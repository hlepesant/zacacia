...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/opt/WebSites/Zacacia/lib/vendor/symfony/test/functional/fixtures/log/i18n_test.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/opt/WebSites/Zacacia/lib/vendor/symfony/test/functional/fixtures/cache/i18n/test/i18n',
  'lifetime' => 31556926,
  'prefix' => '/opt/WebSites/Zacacia/lib/vendor/symfony/test/functional/fixtures/apps/i18n/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'session_path' => '/opt/WebSites/Zacacia/lib/vendor/symfony/test/functional/fixtures/cache/i18n/test/test/sessions',
))));
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/opt/WebSites/Zacacia/lib/vendor/symfony/test/functional/fixtures/cache/i18n/test/template',
  'lifetime' => 86400,
  'prefix' => '/opt/WebSites/Zacacia/lib/vendor/symfony/test/functional/fixtures/apps/i18n/template',
)));
