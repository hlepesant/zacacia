...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/ZacaciaBundle/Entity'))), 'ZacaciaBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('ZacaciaBundle' => 'ZacaciaBundle\\Entity'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/ZacaciaBundle/Resources/views'), 'Zacacia');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('06f56673ac61de449fee7168712ae156838f9a93');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5612f532138ba4.78316183')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ZacaciaBundle' => 'ZacaciaBundle\\ZacaciaBundle',
            ...
            'secret' => '06f56673ac61de449fee7168712ae156838f9a93',
            'locale' => 'en',
            ...
            'kernel.secret' => '06f56673ac61de449fee7168712ae156838f9a93',
