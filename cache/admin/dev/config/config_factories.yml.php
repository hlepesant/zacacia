...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/opt/WebSites/MinivISP/log/admin_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/opt/WebSites/MinivISP/cache/admin/dev/i18n',
  'lifetime' => 31556926,
  'prefix' => '/opt/WebSites/MinivISP/apps/admin/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/opt/WebSites/MinivISP/cache/admin/dev/template',
  'lifetime' => 86400,
  'prefix' => '/opt/WebSites/MinivISP/apps/admin/template',
)));
